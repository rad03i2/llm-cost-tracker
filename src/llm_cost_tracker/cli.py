...
from .core import DEFAULT_PRICES, Price, append_usage, budget_status, load_usage, make_usage, parse_money, summarize
...
def parser() -> argparse.ArgumentParser:
    ...
    q=sub.add_parser("summary"); q.add_argument("--ledger", default="llm-usage.jsonl"); q.add_argument("--budget"); q.add_argument("--json", action="store_true")
...
def main(argv=None) -> int:
    ...
    try:
        if args.command in {"estimate","record"}:
            ...
            out=summarize(load_usage(args.ledger))
